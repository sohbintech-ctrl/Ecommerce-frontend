...
const Header=()=>{
  ...
  const [open, setOpen] = useState(false);
    ...
    return (
      <header className="bg-gray-100 dark:bg-zinc-900 py-2.5 md:py-4 sticky top-0 z-50">
        <div className="flex justify-between items-center px-5 md:flex md:max-w-7xl md:m-auto">
          ...
          <div className="flex gap-2">
            ...
            <div className="md:hidden ml-3">
              <Search
                className="w-4 text-[#DB4444] cursor-pointer relative top-2"
